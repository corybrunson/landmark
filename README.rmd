...
x[landmarks_lastfirst(x, cardinality = 3L, seed_index = 6L)$landmark, ,
  drop = FALSE]
x[landmarks_lastfirst(x, cardinality = 2L, seed_index = 6L)$landmark, ,
  drop = FALSE]
x[landmarks_lastfirst(x, num = 4L, seed_index = 6L)$landmark, ,
  drop = FALSE]
x[landmarks_lastfirst(x, cardinality = 1L, seed_index = 6L)$landmark, ,
  drop = FALSE]
```
